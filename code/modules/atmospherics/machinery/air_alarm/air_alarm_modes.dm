...
/datum/air_alarm_mode/filtering
	name = "Фильтрация"
	desc = "Очищает воздух от загрязнителей"
	danger = FALSE
...
/datum/air_alarm_mode/contaminated
	name = "Загрязнение"
	desc = "Быстро очищает воздух от ВСЕХ загрязнителей"
	danger = FALSE
...
/datum/air_alarm_mode/draught
	name = "Сквозняк"
	desc = "Высасывает воздух с замещением"
	danger = FALSE
...
/datum/air_alarm_mode/refill
	name = "Заполнение"
	desc = "Утроенный выход воздуха из вентиляции"
	danger = TRUE
...
/datum/air_alarm_mode/cycle
	name = "Цикл"
	desc = "Высасывает воздух перед замещением"
	danger = TRUE
...
/datum/air_alarm_mode/siphon
	name = "Выкачка"
	desc = "Высасывает воздух из помещения"
	danger = TRUE
...
/datum/air_alarm_mode/panic_siphon
	name = "Аварийная выкачка"
	desc = "Быстро высасывает воздух из помещения"
	danger = TRUE
...
/datum/air_alarm_mode/off
	name = "Выкл"
	desc = "Отключает вентиляцию и скрубберы"
	danger = FALSE
...
/datum/air_alarm_mode/flood
	name = "Затопление"
	desc = "Отключает скрубберы и открывает вентиляцию"
	danger = TRUE
	emag = TRUE
...
/datum/air_alarm_mode/vent_siphon
	name = "Вентвыкачка"
	desc = "Отключает скрубберы и переводит вентиляцию на выкачку"
	danger = TRUE
