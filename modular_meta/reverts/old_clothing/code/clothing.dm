...
/obj/item/clothing/head/hats/hopcap
	icon = 'modular_meta/reverts/old_clothing/icons/hats.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_hats.dmi'


//RND
/obj/item/clothing/under/rank/rnd/research_director
	icon = 'modular_meta/reverts/old_clothing/icons/rnd.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_rnd.dmi'
...
/obj/item/clothing/under/rank/medical/doctor/skirt
	icon = 'modular_meta/reverts/old_clothing/icons/medical.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_medical.dmi'
...
/obj/item/clothing/head/helmet/chaplain/penitent
	...
	icon = 'modular_meta/reverts/old_clothing/icons/chaplain.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_chaplain.dmi'
	icon_state = "penitent"
...
/obj/item/clothing/suit/chaplainsuit/armor/penitent_armor
	...
	icon = 'modular_meta/reverts/old_clothing/icons/chap.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_chap.dmi'
	icon_state = "penitent_armor"

//COATS
/obj/item/clothing/suit/hooded/wintercoat/security/fluffy
	name = "Security Winter Coat"
	icon = 'modular_meta/reverts/old_clothing/icons/wintercoat.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_wintercoat.dmi'
...
/obj/item/clothing/head/hooded/winterhood/security/fluffy
	icon = 'modular_meta/reverts/old_clothing/icons/winterhood.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_winterhood.dmi'

/obj/item/clothing/suit/armor/vest/russian_coat
	icon = 'modular_meta/reverts/old_clothing/icons/armor.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_armor.dmi'

/obj/item/clothing/suit/captunic
	name = "captain's parade tunic"
	desc = "Worn by a Captain to show their class."
	icon = 'modular_meta/reverts/old_clothing/icons/jacket.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_jacket.dmi'
	icon_state = "captunic"
...
/obj/item/clothing/suit/toggle/labcoat/cmo
	icon = 'modular_meta/reverts/old_clothing/icons/labcoat.dmi'
	worn_icon = 'modular_meta/reverts/old_clothing/icons/mob_labcoat.dmi'
